...
- defesa e dash podem antecipar VFX e pose local, mas bloqueio, dano, cooldown, custo e movimento continuam decisões do servidor;
...
- a CI atual usa permissões mínimas e executa StyLua, Selene, 227 testes de domínio, 59 testes de animação/apresentação, fuzz determinístico de segurança, Wally e build Rojo;
