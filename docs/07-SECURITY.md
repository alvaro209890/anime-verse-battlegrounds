...
- a CI atual usa permissões mínimas e executa StyLua, Selene, 235 testes de domínio, 73 testes de animação/apresentação, fuzz determinístico de segurança, Wally e build Rojo;
