...
- a CI atual usa permissões mínimas e executa StyLua, Selene, 227 testes de domínio, 60 testes de animação/apresentação, fuzz determinístico de segurança, Wally e build Rojo;
